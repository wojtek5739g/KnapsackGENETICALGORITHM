...
def main(argv):
    ...
    for i in range(args.num_of_launches):
        ...
        print(f"{i+1} Launch: ")
        GAbestSpecimen,GAbestSpecimen_max = GeneticAlgorithmComp(GAmodel, cities_coordinates, args.num_of_individuals, args.num_of_iterations, args.mutation_coef, args.crossover_coef, args.tournament_size, args.selection)
        ...
        best_specimenDistanceGEN_min.append(1/GAbestSpecimen_max)
    ...
    comparison_distance_plot(args.num_of_launches, best_specimensDistanceGEN, best_specimensDistanceGA, best_specimenDistanceGEN_min,
                            args.num_of_cities, args.num_of_individuals, args.num_of_iterations,
                            args.mutation_coef, args.crossover_coef, args.selection, args.tournament_size)
